                    ...
                    {{session('success')}}<br>
                     @endif
                        ...
                        <fieldset class="fieldset">
                            ...
                            <div class="form-group">
                                <label class="col-md-2 col-sm-3 col-xs-12 control-label">Chamber</label>
                                <div class="col-md-10 col-sm-9 col-xs-12">
                                    <input type="text" name="chamber" class="form-control" value="{{$user->chamber}}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 col-sm-3 col-xs-12 control-label">Department</label>
                                <div class="col-md-10 col-sm-9 col-xs-12">
                            ...
                            <div class="form-group">
                                <label class="col-md-2 col-sm-3 col-xs-12 control-label">Availability</label>
                                <div class="col-md-10 col-sm-9 col-xs-12">
                                <input type="checkbox" name="day1" value="{{$doctor->availability}">
                                <label for="day1"> Sunday</label><br>
                                <input type="checkbox" name="day2" value="{{$doctor->availability}"">
                                <label for="day2">Monday</label><br>
                                <input type="checkbox" name="day3" value="{{$doctor->availability}"">
                                <label for="day3">Tuesday</label><br>
                                <input type="checkbox" name="day4" value="{{$doctor->availability}"">
                                <label for="day4">Wednesday</label><br>
                                <input type="checkbox" name="day5" value="{{$doctor->availability}"">
                                <label for="day5">Thursday</label><br>
                                <input type="checkbox" name="day6" value="{{$doctor->availability}"">
                                <label for="day6">Friday</label><br>
                                <input type="checkbox" name="day7" value="{{$doctor->availability}"">
                        ...
                        <div class="form-group">
                            <div class="col-md-10 col-sm-9 col-xs-12 col-md-push-2 col-sm-push-3 col-xs-push-0">
                                <input class="btn btn-primary" type="submit" value="Request deactivate account">
                            </div>
                        </div>
                        </div>
